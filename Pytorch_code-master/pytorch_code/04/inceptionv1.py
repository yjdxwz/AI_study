...
class InceptionV1Module(nn.Module):
    def __init__(self, in_channels,out_channels1,
        ...
        self.branch2_conv1 = ConvBNReLU(in_channels=in_channels,
                                        ...
                                        out_channels2reduce,
                                        kernel_size=1)
        self.branch2_conv2 = ConvBNReLU(in_channels=
                                        out_channels2reduce,
        ...
        self.branch3_conv1 = ConvBNReLU(in_channels=in_channels,
                                        ...
                                        out_channels3reduce,
                                        kernel_size=1)
        self.branch3_conv2 = ConvBNReLU(in_channels=
                                        out_channels3reduce,
...
class InceptionAux(nn.Module):
    def __init__(self, in_channels,out_channels):
        ...
        self.auxiliary_avgpool = nn.AvgPool2d(kernel_size=5,
                                              stride=3)
        ...
        self.auxiliary_linear2 = nn.Linear(in_features=1024,
...
class InceptionV1(nn.Module):
    def __init__(self, num_classes=1000, stage='train'):
        ...
        self.block3 = nn.Sequential(
            InceptionV1Module(in_channels=192,
                              out_channels1=64,
                              out_channels2reduce=96,
                              out_channels2=128,
                              out_channels3reduce = 16,
                              out_channels3=32,
                              out_channels4=32),
            InceptionV1Module(in_channels=256,
                              out_channels1=128,
                              out_channels2reduce=128,
                              out_channels2=192,
                              out_channels3reduce=32,
                              out_channels3=96,
                              out_channels4=64),
